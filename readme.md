# <img src="src/assets/favicon.svg" height="50"> riebesell.science

[Gatsby](https://gatsbyjs.org) site hosted at [riebesell.science](https://riebesell.science).

Fully responsive, has [fluid typography](https://css-tricks.com/snippets/css/fluid-typography), relies heavily on [React Hooks](https://reactjs.org/docs/hooks-intro) for stateful function components and [CSS grid](https://developer.mozilla.org/docs/Web/CSS/CSS_Grid_Layout) for layout. It uses the following libraries:
...
1. Clone the repo and `cd` into its directory.
   ...
   ```sh
   git clone https://github.com/janosh/riebesell.science \
   && cd riebesell.science
   ```
